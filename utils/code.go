...
func (cp *CodeGenerationPlan) generateChannel() {
	...
	sccp := StaticCodeCopyPlan{
		filePathAlterations: []StaticCodeFilePathAlteration{
			...
			{
				filePathToRead:  fmt.Sprintf("%s/servers/nakama/data/modules/channel.lua.omgdtpl", staticDir),
				filePathToWrite: fmt.Sprintf("%s/servers/nakama/data/modules/%s.lua.omgdtpl", tmpDir, snakeChannel),
			},
			{
				filePathToRead:  fmt.Sprintf("%s/servers/nakama/data/modules/channel_manager.lua.omgdtpl", staticDir),
				filePathToWrite: fmt.Sprintf("%s/servers/nakama/data/modules/%s_manager.lua.omgdtpl", tmpDir, snakeChannel),
			},
		},
	}
