...
func TestDeployInfra(t *testing.T) {
	...
	// 5. Build templates should execute
	testFileShouldExist(t, fmt.Sprintf("%s/.omgdtmp/.omgd/server/infra/gcp/terraform.tfvars", testDir))

	cmdDirStr := fmt.Sprintf("%s/.omgdtmp", testDir)
	cmdDirStrTf := fmt.Sprintf("%s/.omgd/server/infra/gcp/", cmdDirStr)
	...
	testForFileAndRegexpMatch(t, fmt.Sprintf("%s/.omgdtmp/profiles/staging.yml", testDir), "127.6.6.6")
	testForFileAndRegexpMatch(t, fmt.Sprintf("%s/.omgdtmp/.omgd/staging.yml", testDir), "127.6.6.6")
}
...
func TestDeployInfraWithoutCopying(t *testing.T) {
	...
	cmdDirStrTf := fmt.Sprintf("%s/.omgd/server/infra/gcp/", testDir)
